...
export function Hero() {
  ...
  return (
    <div className="relative min-h-[90vh] flex flex-col justify-center pt-20 pb-20 overflow-hidden bg-gradient-to-br from-slate-800 via-purple-900 to-slate-900">
      {/* Background Elements */}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col items-center text-center">
        ...
        <div className="space-y-8 flex flex-col items-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Tạo ra những mẫu thiết kế độc đáo chỉ trong vài giây với sức mạnh của AI. 
            Thỏa sức sáng tạo và đặt hàng ngay lập tức.
          </p>
          ...
          <div className="pt-12 mt-8 grid grid-cols-2 gap-12 sm:gap-24 border-t border-white/10">
            <div>
              <p className="text-4xl font-bold text-white">10k+</p>
              <p className="text-gray-400 text-sm mt-1">Design Generated</p>
            </div>
            <div>
